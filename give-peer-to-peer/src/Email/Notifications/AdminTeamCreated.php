 ...
 * @since 1.5.0
 */
class AdminTeamCreated extends Give_Email_Notification
{
    ...
    public function init()
    {
        $this->load(
            [
                'id' => 'p2p-admin-new-team-created',
                'label' => __('New Team Created - No Approval Needed', 'give-peer-to-peer'),
                'description' => __('Sent to the administrator when a new team is created.',
                    'give-peer-to-peer'),
                ...
                'default_email_subject' => esc_attr__('New Team Created - No Approval Needed!',
                    'give-peer-to-peer'),
                'default_email_message' => $this->getDefaultEmailMessage(),
                'default_email_header' => __('New Team Created - No Approval Needed', 'give-peer-to-peer'),
            ]
        );
    ...
    public function getDefaultEmailMessage(): string
    {
        $defaultEmailMessage = sprintf(
            ...
            esc_html__('A new team has been created for %s !', 'give-peer-to-peer') . "\n\n" .
            esc_html__('Team Captain: %s', 'give-peer-to-peer') . "\n\n" .
            esc_html__('Team Name: %s ', 'give-peer-to-peer') . "\n\n" .
            esc_html__('View all teams here:',
        ...
        <div class="give_preview_email_user_id_main">
            ...
            echo Give()->html->select(
                [
                    ...
                    'class' => 'give-preview-email-admin-team-created',
                    'options' => $options,
                    'chosen' => false,
