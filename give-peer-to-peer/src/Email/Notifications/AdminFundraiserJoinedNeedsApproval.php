 ...
 * @since 1.5.0
 */
class AdminFundraiserJoinedNeedsApproval extends Give_Email_Notification
{
    ...
    public function init()
    {
        $this->load(
            [
                'id' => 'p2p-admin-fundraiser-joined-approval',
                'label' => __('New Fundraiser Joined - Needs Approval', 'give-peer-to-peer'),
                'description' => __('Sent to the administrator when a new fundraiser has joined a campaign and requires approval.',
                    'give-peer-to-peer'),
                ...
                'default_email_subject' => esc_attr__('New Fundraiser Created - Needs Approval!',
                    'give-peer-to-peer'),
                'default_email_message' => $this->getDefaultEmailMessage(),
                'default_email_header' => __('New Fundraiser Created - Needs Approval!', 'give-peer-to-peer'),
            ]
        );
    ...
    public function getDefaultEmailMessage(): string
    {
        $defaultEmailMessage = sprintf(
            ...
            esc_html__('A new fundraiser has joined %s and requires approval!',
                'give-peer-to-peer') . "\n\n" .
            esc_html__('Fundraiser Name: ', 'give-peer-to-peer') . '%s' . "\n\n" .
            esc_html__('View and approve all fundraisers here: ',
