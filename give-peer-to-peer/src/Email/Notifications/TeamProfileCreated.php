 ...
 * @since 1.5.0
 */
class TeamProfileCreated extends Give_Email_Notification
{
    ...
    public function init()
    {
        $this->load(
            [
                'id' => 'p2p-new-team-profile-created',
                'label' => __('New Team Profile Created', 'give-peer-to-peer'),
                'description' => __('Sent to designated recipient(s) when a new team profile is created.',
                    'give-peer-to-peer'),
                ...
                'default_email_subject' => esc_attr__(' Your team {team_name} for {campaign_name} has been created!',
                    'give-peer-to-peer'),
                'default_email_message' => $this->getDefaultEmailMessage(),
                'default_email_header' => __('Team Profile Created', 'give-peer-to-peer'),
            ]
        );
        ...
        if ('disabled' != $this->get_notification_status()) {
            add_action('give_p2p_team_created', [$this, 'sendEmailNotificationToTeamCaptain']);
        }
    }
    ...
    public function getDefaultEmailMessage(): string
    {
        $defaultEmailMessage = sprintf(
            ...
            esc_html__('Your team %s for %s has been created!', 'give-peer-to-peer') . "\n\n" .
