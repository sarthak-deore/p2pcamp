...
import {LoadingOverlay, Spinner} from '@p2p/Components/Admin';
import {useHistory} from 'react-router-dom';

import styles from './style.module.scss';
import {BlankSlateIcon} from '@p2p/Components/Icons';

const {__} = wp.i18n;

const Table = ({title, columns, data, columnFilters, stripped, isLoading, isSorting, blankSlate, ...rest}) => {
        ...
        if (!isLoading && data.length === 0) {
            return (
                <div className={styles.noData}>
                    <div className={styles.noDataSVG}>
                        <BlankSlateIcon />
                    </div>
