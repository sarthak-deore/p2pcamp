...
import LoadingOverlay from '@p2p/Components/Admin/LoadingOverlay';
...
Modal.AdditionalContext = ({type, context, ...rest}) => {
    const title = ['error', 'failed'].includes(type)
        ? __('Error details', 'give-peer-to-peer')
        : __('Additional context', 'give-peer-to-peer');
