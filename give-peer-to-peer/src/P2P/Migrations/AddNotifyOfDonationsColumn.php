...
class AddNotifyOfDonationsColumn extends Migration {
    /**
     * @inheritdoc
     */
    public static function id() {
        return 'give-p2p-add-notify-of-donations-column';
    }
    ...
    public static function title() {
        return __('Add Notify Of Donations Column', 'give-peer-to-peer');
    }
    ...
    public function run() {
        ...
        $sql = "
            ALTER TABLE $table
            ADD notify_of_donations TINYINT(1) NOT NULL DEFAULT '0'
        ";
