...
class App
{
    ...
    public function getOutput( $attributes ): string
    {
        ...
        $shadowRootStylesheet = GIVE_P2P_URL . 'public/css/give-p2p-team-leaderboard.css';
    ...
    /**
     * @since 1.6.0
     * Get template path for Team Leaderboard component
     **/

    public function getTemplatePath(): string
    {
        return GIVE_P2P_DIR . '/src/Blocks/TeamLeaderboard/resources/views/teamleaderboard.php';
    }

    /**
     *@since 1.6.0
     * Enqueue assets for Team Leaderboard
     **/
    ...
    public function loadAssets() : void
    {
        ...
        wp_enqueue_script(
            'give-p2p-team-leaderboard',
            GIVE_P2P_URL . 'public/js/give-p2p-team-leaderboard.js',
        ...
        wp_set_script_translations('give-p2p-team-leaderboard', 'give-peer-to-peer');
